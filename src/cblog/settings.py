...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone-rds.cra5cmpkpxxq.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3ayhanblog' # please enter your s3 bucket name
