...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonerds.cra5cmpkpxxq.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'capstone-s3-video-pic' # please enter your s3 bucket name
